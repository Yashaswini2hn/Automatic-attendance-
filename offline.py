...
class VideoPlayer:
    def __init__(self, master):
            self.master = master
            self.master.title("Offline Video Player")
            ...
            # create widgets
            self.button_browse = tk.Button(self.master, text="Browse..", command=self.browse_video,borderwidth="10",bg="red",activebackground="green")
            self.button_browse.place(x=670, y=100)
            ...
            self.button_screenshot.place(x=670, y=200)
            ...
            self.button_compare_faces.place(x=670, y=300)
            ...
            self.button_compare_faces.place(x=670, y=400)
    ...
    def delete_old_subfolders(self, parent_folder="screenshot_offline", days_old=7):
    ...
    def take_screenshot(self):
        ...
        if ret:
            ...
            parent_folder = "screenshot_offline"
